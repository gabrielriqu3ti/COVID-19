...
%% Importação de dados
data_campinas = readtable('../data/dados_campinas.csv');

summary(data_campinas);
[n_days, ~] = size(data_campinas.data);
day_medium = ceil(n_days / 2);

disp(['Número de dados: ', num2str(n_days)])

pop_campinas = data_campinas.pop(1);
...
%% Filtragem
new_cases_moving_avg_3 = conv_moving_avg_filter(data_campinas.casos_novos, 3);
new_cases_moving_avg_5 = conv_moving_avg_filter(data_campinas.casos_novos, 5);
new_cases_moving_avg_7 = conv_moving_avg_filter(data_campinas.casos_novos, 7);
new_cases_gaussian_3 = conv_gaussian_filter(data_campinas.casos_novos, 3);
new_cases_gaussian_5 = conv_gaussian_filter(data_campinas.casos_novos, 5);
new_cases_gaussian_7 = conv_gaussian_filter(data_campinas.casos_novos, 7);

new_cases_notch = filter(b_c, a_c, data_campinas.casos_novos);
...
new_cases_per_pop_moving_avg_3 = conv_moving_avg_filter(data_campinas.casos_novos_por_pop, 3);
new_cases_per_pop_moving_avg_5 = conv_moving_avg_filter(data_campinas.casos_novos_por_pop, 5);
new_cases_per_pop_moving_avg_7 = conv_moving_avg_filter(data_campinas.casos_novos_por_pop, 7);
new_cases_per_pop_gaussian_3 = conv_gaussian_filter(data_campinas.casos_novos_por_pop, 3);
new_cases_per_pop_gaussian_5 = conv_gaussian_filter(data_campinas.casos_novos_por_pop, 5);
new_cases_per_pop_gaussian_7 = conv_gaussian_filter(data_campinas.casos_novos_por_pop, 7);

new_cases_per_pop_notch = filter(b_c, a_c, data_campinas.casos_novos_por_pop);
...
isolation_moving_avg_3 = conv_moving_avg_filter(data_campinas.indice_isolamento, 3);
isolation_moving_avg_5 = conv_moving_avg_filter(data_campinas.indice_isolamento, 5);
isolation_moving_avg_7 = conv_moving_avg_filter(data_campinas.indice_isolamento, 7);
isolation_gaussian_3 = conv_gaussian_filter(data_campinas.indice_isolamento, 3);
isolation_gaussian_5 = conv_gaussian_filter(data_campinas.indice_isolamento, 5);
isolation_gaussian_7 = conv_gaussian_filter(data_campinas.indice_isolamento, 7);

isolation_notch = filter(b_i, a_i, data_campinas.indice_isolamento);
...
subplot(421)
stem(data_campinas.data, data_campinas.casos_novos, 'filled', 'MarkerSize', 3,...
...
legend('original')
xlim([data_campinas.data(1), data_campinas.data(n_days)])

subplot(422)
stem(data_campinas.data, new_cases_notch, 'filled', 'MarkerSize', 3,...
...
subplot(423)
stem(data_campinas.data, new_cases_moving_avg_3, 'filled', 'MarkerSize', 3, ...
...
subplot(425)
stem(data_campinas.data, new_cases_moving_avg_5, 'filled', 'MarkerSize', 3,...
...
subplot(427)
stem(data_campinas.data, new_cases_moving_avg_7, 'filled', 'MarkerSize', 3,...
...
subplot(424)
stem(data_campinas.data, new_cases_gaussian_3, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_3, 'MarkerFaceColor', marker_color_3, 'MarkerEdgeColor', marker_color_3)
...
subplot(426)
stem(data_campinas.data, new_cases_gaussian_5, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_5, 'MarkerFaceColor', marker_color_5, 'MarkerEdgeColor', marker_color_5)
...
subplot(428)
stem(data_campinas.data, new_cases_gaussian_7, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_7, 'MarkerFaceColor', marker_color_7, 'MarkerEdgeColor', marker_color_7)
title(['Filtragem gaussiana 7 do número de novos casos diários de COVID-19 em ', city])
legend('gaussian 7')
xlim([data_campinas.data(1), data_campinas.data(n_days)])

saveas(gcf, '../images/campinas_novos_casos_filtragem.png')
...
subplot(423)
stem(data_campinas.data, new_cases_moving_avg_3_notch, 'filled', 'MarkerSize', 3, ...
    'LineWidth', 0.1, 'Color', bar_color_3, 'MarkerFaceColor', marker_color_3, 'MarkerEdgeColor', marker_color_3)
...
subplot(425)
stem(data_campinas.data, new_cases_moving_avg_5_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_5, 'MarkerFaceColor', marker_color_5, 'MarkerEdgeColor', marker_color_5)
...
subplot(427)
stem(data_campinas.data, new_cases_moving_avg_7_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_7, 'MarkerFaceColor', marker_color_7, 'MarkerEdgeColor', marker_color_7)
...
subplot(424)
stem(data_campinas.data, new_cases_gaussian_3_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_3, 'MarkerFaceColor', marker_color_3, 'MarkerEdgeColor', marker_color_3)
...
subplot(426)
stem(data_campinas.data, new_cases_gaussian_5_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_5, 'MarkerFaceColor', marker_color_5, 'MarkerEdgeColor', marker_color_5)
...
subplot(428)
stem(data_campinas.data, new_cases_gaussian_7_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_7, 'MarkerFaceColor', marker_color_7, 'MarkerEdgeColor', marker_color_7)
title(['Filtragem gaussiana 7 e notch com r=', num2str(r_c), ' do número de novos casos diários de COVID-19 em ', city])
legend('gaussian 7')
xlim([data_campinas.data(1), data_campinas.data(n_days)])

saveas(gcf, '../images/campinas_novos_casos_filtragem_notch.png')
...
set(gcf,'position',[0,0,1500,860])
subplot(421)
stem(data_campinas.data, per_pop * data_campinas.casos_novos_por_pop, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_src, 'MarkerFaceColor', marker_color_src, 'MarkerEdgeColor', marker_color_src)
...
subplot(422)
stem(data_campinas.data, per_pop * new_cases_per_pop_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_notch, 'MarkerFaceColor', marker_color_notch, 'MarkerEdgeColor', marker_color_notch)
...
subplot(423)
stem(data_campinas.data, per_pop * new_cases_per_pop_moving_avg_3, 'filled', 'MarkerSize', 3, ...
    'LineWidth', 0.1, 'Color', bar_color_3, 'MarkerFaceColor', marker_color_3, 'MarkerEdgeColor', marker_color_3)
...
subplot(425)
stem(data_campinas.data, per_pop * new_cases_per_pop_moving_avg_5, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_5, 'MarkerFaceColor', marker_color_5, 'MarkerEdgeColor', marker_color_5)
...
subplot(427)
stem(data_campinas.data, per_pop * new_cases_per_pop_moving_avg_7, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_7, 'MarkerFaceColor', marker_color_7, 'MarkerEdgeColor', marker_color_7)
...
subplot(424)
stem(data_campinas.data, per_pop * new_cases_per_pop_gaussian_3, 'filled', 'MarkerSize', 3, ...
    'LineWidth', 0.1, 'Color', bar_color_3, 'MarkerFaceColor', marker_color_3, 'MarkerEdgeColor', marker_color_3)
...
subplot(426)
stem(data_campinas.data, per_pop * new_cases_per_pop_gaussian_5, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_5, 'MarkerFaceColor', marker_color_5, 'MarkerEdgeColor', marker_color_5)
...
subplot(428)
stem(data_campinas.data, per_pop * new_cases_per_pop_gaussian_7, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_7, 'MarkerFaceColor', marker_color_7, 'MarkerEdgeColor', marker_color_7)
title(['Filtragem gaussiana 7 do número de novos casos diários de COVID-19 por ', num2str(per_pop), ' habitantes em ', city])
legend('gaussian 7')
xlim([data_campinas.data(1), data_campinas.data(n_days)])

saveas(gcf, '../images/campinas_novos_casos_por_pop_filtragem.png')
...
subplot(423)
stem(data_campinas.data, per_pop * new_cases_per_pop_moving_avg_3_notch, 'filled', 'MarkerSize', 3, ...
    'LineWidth', 0.1, 'Color', bar_color_3, 'MarkerFaceColor', marker_color_3, 'MarkerEdgeColor', marker_color_3)
...
subplot(425)
stem(data_campinas.data, per_pop * new_cases_per_pop_moving_avg_5_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_5, 'MarkerFaceColor', marker_color_5, 'MarkerEdgeColor', marker_color_5)
...
subplot(427)
stem(data_campinas.data, per_pop * new_cases_per_pop_moving_avg_7_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_7, 'MarkerFaceColor', marker_color_7, 'MarkerEdgeColor', marker_color_7)
...
subplot(424)
stem(data_campinas.data, per_pop * new_cases_per_pop_gaussian_3_notch, 'filled', 'MarkerSize', 3, ...
    'LineWidth', 0.1, 'Color', bar_color_3, 'MarkerFaceColor', marker_color_3, 'MarkerEdgeColor', marker_color_3)
...
subplot(426)
stem(data_campinas.data, per_pop * new_cases_per_pop_gaussian_5_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_5, 'MarkerFaceColor', marker_color_5, 'MarkerEdgeColor', marker_color_5)
...
subplot(428)
stem(data_campinas.data, per_pop * new_cases_per_pop_gaussian_7_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_7, 'MarkerFaceColor', marker_color_7, 'MarkerEdgeColor', marker_color_7)
title(['Gaussiana 7 e notch com r=', num2str(r_c), ' do número de novos casos por ', num2str(per_pop), ' habitantes em ', city])
legend('gaussian 7')
xlim([data_campinas.data(1), data_campinas.data(n_days)])

saveas(gcf, '../images/campinas_novos_casos_por_pop_filtragem_notch.png')
...
set(gcf,'position',[0,0,1500,860])
subplot(421)
stem(data_campinas.data, data_campinas.indice_isolamento, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_src, 'MarkerFaceColor', marker_color_src, 'MarkerEdgeColor', marker_color_src)
...
subplot(422)
stem(data_campinas.data, isolation_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_notch, 'MarkerFaceColor', marker_color_notch, 'MarkerEdgeColor', marker_color_notch)
...
subplot(423)
stem(data_campinas.data, isolation_moving_avg_3, 'filled', 'MarkerSize', 3, ...
    'LineWidth', 0.1, 'Color', bar_color_3, 'MarkerFaceColor', marker_color_3, 'MarkerEdgeColor', marker_color_3)
...
subplot(425)
stem(data_campinas.data, isolation_moving_avg_5, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_5, 'MarkerFaceColor', marker_color_5, 'MarkerEdgeColor', marker_color_5)
...
subplot(427)
stem(data_campinas.data, isolation_moving_avg_7, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_7, 'MarkerFaceColor', marker_color_7, 'MarkerEdgeColor', marker_color_7)
...
subplot(424)
stem(data_campinas.data, isolation_gaussian_3, 'filled', 'MarkerSize', 3, ...
    'LineWidth', 0.1, 'Color', bar_color_3, 'MarkerFaceColor', marker_color_3, 'MarkerEdgeColor', marker_color_3)
...
subplot(426)
stem(data_campinas.data, isolation_gaussian_5, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_5, 'MarkerFaceColor', marker_color_5, 'MarkerEdgeColor', marker_color_5)
...
subplot(428)
stem(data_campinas.data, isolation_gaussian_7, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_7, 'MarkerFaceColor', marker_color_7, 'MarkerEdgeColor', marker_color_7)
...
saveas(gcf, '../images/campinas_isolamento_filtragem.png')
...
subplot(423)
stem(data_campinas.data, isolation_moving_avg_3_notch, 'filled', 'MarkerSize', 3, ...
    'LineWidth', 0.1, 'Color', bar_color_3, 'MarkerFaceColor', marker_color_3, 'MarkerEdgeColor', marker_color_3)
...
subplot(425)
stem(data_campinas.data, isolation_moving_avg_5_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_5, 'MarkerFaceColor', marker_color_5, 'MarkerEdgeColor', marker_color_5)
...
subplot(427)
stem(data_campinas.data, isolation_moving_avg_7_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_7, 'MarkerFaceColor', marker_color_7, 'MarkerEdgeColor', marker_color_7)
...
subplot(424)
stem(data_campinas.data, isolation_gaussian_3_notch, 'filled', 'MarkerSize', 3, ...
    'LineWidth', 0.1, 'Color', bar_color_3, 'MarkerFaceColor', marker_color_3, 'MarkerEdgeColor', marker_color_3)
...
subplot(426)
stem(data_campinas.data, isolation_gaussian_5_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_5, 'MarkerFaceColor', marker_color_5, 'MarkerEdgeColor', marker_color_5)
...
subplot(428)
stem(data_campinas.data, isolation_gaussian_7_notch, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_7, 'MarkerFaceColor', marker_color_7, 'MarkerEdgeColor', marker_color_7)
...
saveas(gcf, '../images/campinas_isolamento_filtragem_notch.png')
...
subplot(311)
fill([quarantene_begin, quarantene_end, quarantene_end, quarantene_begin], [0, 0, 1.5*max(data_campinas.casos_novos), 1.5*max(data_campinas.casos_novos)], ...
...
subplot(312)
fill([quarantene_begin, quarantene_end, quarantene_end, quarantene_begin], [0, 0, 2*max(new_cases_per_pop_gaussian_7_notch*per_pop), 2*max(new_cases_per_pop_gaussian_7_notch*per_pop)], ...
    quarantene_color, 'FaceAlpha', 0.5, 'EdgeColor', 'none')
hold on
stem(data_campinas.data, per_pop * data_campinas.casos_novos_por_pop, 'filled', 'MarkerSize', 3,...
    'LineWidth', 0.1, 'Color', bar_color_src, 'MarkerFaceColor', marker_color_src, 'MarkerEdgeColor', marker_color_src)
...
saveas(gcf, '../images/campinas_dados_originais.png')
...
saveas(gcf, '../images/campinas_dados_filtrados.png')
